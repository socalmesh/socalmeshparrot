...
const createDiscordMessage = async (packetGroup, text) => {
  try {
    ...
    const content = {
      ...
      embeds: [
        {
          url: `https://socalmesh.w4hac.com/packet_list/${packet.from}`,
          color: 6810260,
          ...
          fields: [
            ...
            {
              name: "Packet",
              value: `[${packetGroup.id.toString(16)}](https://socalmesh.w4hac.com/packet/${packetGroup.id})`,
              inline: true,
            },
            {
              name: "Channel",
            ...
            ...packetGroup.serviceEnvelopes
              ...
              .map((envelope) => {
                ...
                return {
                  name: `Gateway`,
                  value: `[${gatewayDisplaName} (${hopText})](https://socalmesh.w4hac.com/packet_list/${nodeHex2id(envelope.gatewayId.replace("!", ""))})${gatewayDelay > 0 ? " (" + gatewayDelay + "ms)" : ""}`,
                  inline: true,
                };
              }),
          ],
